...
type Props = {};
const primaryBtn =
  "hidden rounded-xl bg-blue-500 px-6 py-2 text-sm font-bold text-white transition duration-200 hover:bg-blue-600 lg:inline-block";
const secondaryBtn =
  "hidden rounded-xl bg-gray-50 px-6 py-2 text-sm font-bold text-gray-900 transition duration-200 hover:bg-gray-100  lg:ml-auto lg:mr-3 lg:inline-block";
